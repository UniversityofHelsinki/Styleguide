...
Icons are generated by Icomoon. To update icons goto https://icomoon.io/app/#/projects and import icomoon/hy-icons.json. Add new Icons and generate font. Copy generated contents to icomoon folder. Also download the updated project json file and overwrite hy-icons.json. Also update styleguide browser template to show the new icons.
